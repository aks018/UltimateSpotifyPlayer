package aviee.develop.music.myultimatesongexperienceforspotify.notification;
...
public class NotificationGenerator {
    public static final String NOTIFY_PREVIOUS = "com.example.avi.ultimatespotifyplayer.notification.previous";
    public static final String NOTIFY_DELETE = "com.example.avi.ultimatespotifyplayer.notification.delete";
    public static final String NOTIFY_PAUSE = "com.example.avi.ultimatespotifyplayer.notification.pause";
    public static final String NOTIFY_PLAY = "com.example.avi.ultimatespotifyplayer.notification.play";
    public static final String NOTIFY_NEXT = "com.example.avi.ultimatespotifyplayer.notification.next";
