package aviee.develop.music.myultimatesongexperienceforspotify.adapter;
...
import aviee.develop.music.myultimatesongexperienceforspotify.MainActivity;
import aviee.develop.music.myultimatesongexperienceforspotify.R;
import aviee.develop.music.myultimatesongexperienceforspotify.YoutubeActivity;
...
import aviee.develop.music.myultimatesongexperienceforspotify.pojo.RandomItems;
import aviee.develop.music.myultimatesongexperienceforspotify.pojo.RandomSong;
import aviee.develop.music.myultimatesongexperienceforspotify.pojo.RandomTracks;
...
public class SongBaseAdapter extends BaseAdapter implements Filterable, Serializable {
    ...
    public View getView(int position, final View convertView, final ViewGroup parent) {
        ...
        rowView = inflater.inflate(aviee.develop.music.myultimatesongexperienceforspotify.R.layout.song_adapter, parent, false);

        holder.trackName = (TextView) rowView.findViewById(aviee.develop.music.myultimatesongexperienceforspotify.R.id.textViewSongName);
        holder.artistName = (TextView) rowView.findViewById(aviee.develop.music.myultimatesongexperienceforspotify.R.id.textViewArtistName);
        holder.albumName = (TextView) rowView.findViewById(aviee.develop.music.myultimatesongexperienceforspotify.R.id.textViewAlbumName);
        holder.dropDown = (ImageView) rowView.findViewById(aviee.develop.music.myultimatesongexperienceforspotify.R.id.viewMusicVideo);
        ...
        holder.dropDown.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                popup.getMenuInflater().inflate(aviee.develop.music.myultimatesongexperienceforspotify.R.menu.popup_menu,
                        popup.getMenu());
                popup.show();
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case aviee.develop.music.myultimatesongexperienceforspotify.R.id.musicVideo:
                                ...
                                break;
                            case aviee.develop.music.myultimatesongexperienceforspotify.R.id.randomSong:
